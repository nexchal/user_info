$(function () // 체크박스 체크 시 적용된 css 제거
{
  ...
  function CheckUpdate()
    ...
    function CheckDelete()
      ...
      {
        window.open(`/searchuser`, "search", "width=900, height=300, left=100, top=50");
      }

      function SearchCheck(win)
      {
      ...
      {
        var utel = document.form.tel;
        var uname = document.form.name;
        var unum = document.form.emp_no;
        console.log(`utel=`+utel.value);
        if(utel.value === '')
        {
        ...
        {
          alert("Input Your Employee Number!");
        }
        else
        {
